...
export default function SettingsPage() {
  ...
  // Ghost Writer state
  type GhostStyle = { style_summary: string; tone_keywords: string; sample_emails: string[] } | null;
  ...
  async function handleAnalyzeStyle() {
    ...
    try {
      ...
      const data = await res.json() as { ok?: boolean; style?: { style_summary: string; tone_keywords: string; sample_emails: string[] }; error?: string };
      if (!res.ok) {
  ...
  return (
    <div style={{ padding: "32px 32px 64px", maxWidth: 680, margin: "0 auto" }}>
      ...
      <div style={{
        ...
        {/* Lock overlay for non-agency */}
        {!isAgency && (
          <div style={{
            position: "absolute", inset: 0, borderRadius: 14,
            background: "linear-gradient(160deg, rgba(14,14,14,0.5) 0%, rgba(14,14,14,0.9) 100%)",
            backdropFilter: "blur(4px)",
            display: "flex", flexDirection: "column",
            alignItems: "center", justifyContent: "center", gap: 10,
            padding: 24, zIndex: 2,
            ...
            <p style={{
              ...
              fontFamily: "var(--font-outfit)", textAlign: "center", maxWidth: 300,
            }}>
              Train AI to write in your exact voice — tone, vocabulary, sentence structure and all.
            </p>
            <button
        ...
        <div style={{ opacity: isAgency ? 1 : 0.15 }}>
          ...
          {ghostLoading && isAgency ? (
            ...
            /* ── Training form ── */
            <div>
              <p style={{ fontSize: 13, color: "rgba(255,255,255,0.45)", fontFamily: "var(--font-outfit)", lineHeight: 1.6, marginBottom: 20 }}>
              ...
              <div style={{ display: "flex", gap: 10 }}>
                <button
                  ...
                  style={{
                    ...
                    fontSize: 13.5, fontWeight: 700, fontFamily: "var(--font-outfit)",
