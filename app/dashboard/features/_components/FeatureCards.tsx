...
import { Zap, GitBranch, Target, Files } from "lucide-react";
      ...
      <ul style={{ listStyle: "none", margin: 0, padding: 0, display: "flex", flexDirection: "column", gap: 7 }}>
        {highlights.map((item) => (
          <li key={item} style={{ display: "flex", alignItems: "center", gap: 9 }}>
            <span style={{ width: 4, height: 4, borderRadius: "50%", backgroundColor: "#FF5200", flexShrink: 0 }} />
            <span style={{ fontSize: 13, color: "rgba(255,255,255,0.6)", fontFamily: "var(--font-outfit)" }}>
              {item}
            </span>
          </li>
        ))}
