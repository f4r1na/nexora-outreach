...
export function StatCard({
  ...
  return (
    <div className="group rounded-md border border-border bg-card p-4 stat-card animate-fade-in card-shadow">
      <div className="flex items-start justify-between">
        ...
        <div
          className={cn(
            "rounded bg-secondary p-2 transition-transform duration-200 group-hover:rotate-[5deg]",
            iconColor
          )}
        >
